...
### sample code to use in sdm IS_analysis ###

# download 'IS_sample_data.zip' file with sample data
...
# set root path to downloaded source files
rootDir<-"C:/Users/Downloads/IS_sample_data/"
# set working directory to main analysis folder
setwd(rootDir)

# select name for project and create directory
project_run<-"sdm_sample_run"
...
# location of downloaded scripts and code
codeDir<-"C:/Users/Downloads/IS_V2-master/"
...
fitting_bios<-paste0(bioclims, "all_baseline/current_5min/")
...
all_sp_nm = c('Falcataria_moluccana', 'Panicum_maximum')
...
env_var_files = c("bio1.tif", "bio12.tif") 
